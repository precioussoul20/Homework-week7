 ...
 *firstName.isEmpty() returns true if the String is empty or in other words, when the String does not contain
 * any characters.
 * TEST EXAMPLE
...
public class Person {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("fullname= " + person.getFullName());
        System.out.println("teen= " + person.isTeen());
        person.setLastname("Smith"); // last name is set smith
        System.out.println("fullname= " + person.getFullName());
    }
}
